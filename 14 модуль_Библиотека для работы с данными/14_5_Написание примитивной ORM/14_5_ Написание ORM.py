...
from crud_functions_products import *
from crud_funcrions_users import *
...
async def set_age(message, state):
    await state.update_data(ages=message.text)
    data = await state.get_data()
    add_user(data['usname'], data['e_mail'], data['ages'])
    await state.finish()
